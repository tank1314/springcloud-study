...
public class JacksonUtils {
    ...
    public static <T> T readJsonString(String jsonString, Class<T> clazz) throws IOException {
        try {
     ...
     * @return 目标对象
     */
    public static <T> T readJsonString(String jsonString, JavaType javaType) throws IOException {
        try {
